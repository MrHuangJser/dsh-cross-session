...
var MissingServiceError = class extends Error {
	...
	constructor(service, purpose) {
		super(`@huangjiangheng/dsh-cross-session requires the "${service}" Host service (${purpose}), but this deployment does not compose it. Add the plugin that provides "${service}" to the host composition, or disable this plugin.`);
